...
### (3) Machine-Learning Classifiers
   **Pre-requisites**: [Auto-Weka v0.5](http://www.cs.ubc.ca/labs/beta/Projects/autoweka/) equipped with [SMAC v2.10.03](https://www.cs.ubc.ca/labs/beta/Projects/SMAC/v2.10.03/quickstart.html).
   [**Note**: A [*.zip* file](https://github.com/davewilsonfbc/smapeaqn.ml/blob/main/autoweka-0.5-with-SMAC-2.10.03.zip) is available in this repository, providing a predefined Auto-Weka bundle.]
